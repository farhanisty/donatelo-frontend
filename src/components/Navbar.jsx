  ...
  if (solid) {
    return (
      <>
        ...
        />
        <nav
          className={`sticky flex justify-between w-full px-5 h-[50px] items-center z-20 top-0 transition-colors duration-500 backdrop-blur bg-white/50`}
        >
          <ul
            onClick={() => {
          ...
          >
            <li
              className={`w-full h-[2px] transition-all duration-500 ${showNavbar ? "origin-left rotate-[37deg] bg-black" : ""} bg-black`}
            ></li>
            <li
              className={`w-full h-[2px] transition-all duration-500 ${showNavbar ? "scale-0 bg-black" : ""} bg-black`}
            ></li>
            <li
              className={`w-full h-[2px] transition-all duration-500 ${showNavbar ? "origin-left -rotate-[37deg] bg-black" : ""} bg-black`}
            ></li>
          ...
          <ul
            className={`${showNavbar ? "" : "-translate-x-[100vw]"} transition-transform duration-500 gap-5 flex flex-col md:flex-row md:translate-x-0 pt-[5rem] md:pt-0 px-[2rem] md:px-0 fixed md:static inset-0 z-[1000] bg-background text-black md:bg-transparent`}
          >
            <li
          ...
          <div className="absolute w-full h-full top-0 left-0 flex justify-center items-center">
            <h1
              className={`justify-self-center font-['caveat'] transition-colors duration-500 text-4xl`}
            >
